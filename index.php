    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 fixed-top">
      ...
      <section id="home">
        <div class="container">
            <h2>Barang Baru</h2>
            <h1>Beli Sekarang</h1>
            <p> Beli sekarang untuk harga paling murah</p>
            <button>Beli</button>
        </div>
      </section>
      ...
      <section id="brand" class="container">
        <div class="row">
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="Assets/imgs/radin.jpg"/>
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="Assets/imgs/dongfeng.jpg"/>
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="Assets/imgs/Kubota-Logo.jpg"/>
        </div>
      </section>
      ...
      <section id="new" class="w-100">
        <div class="row p-0 m-0">
          <!--One-->
          <div onclick="window.location.href='ValveCategory.html';" class="one col-lg-4 col-md-12 col-sm-12 p-0">
            <img class="img-fluid" src="Assets/imgs/valve.jpg">
            <div class="details">
              <h2>Valve</h2>
              <button class="text-uppercase">Beli Sekarang</button>
            </div>
          </div>
          <!--DUA-->
          <div onclick="window.location.href='PistonCategory.html';" class="one col-lg-4 col-md-12 col-sm-12 p-0">
            <img class="img-fluid" src="Assets/imgs/Genuine-Piston-for-Diesel-Engine-3803312.jpg">
            <div class="details">
              <h2>Piston</h2>
              <button class="text-uppercase">Beli Sekarang</button>
            </div>
          ...
          <!--Tiga-->
          <div onclick="window.location.href='FilterCategory.html';" class="one col-lg-4 col-md-12 col-sm-12 p-0">
            <img class="img-fluid" src="Assets/imgs/Oilscreen.jpg">
            <div class="details">
              <h2>Filter</h2>
              <button class="text-uppercase">Beli Sekarang</button>
            </div>
      ...
      <section id="featured" class="my-5 pb-5">
        <div class="container text-center mt-5 py-5">
          <h3> Spareparts Lainnya</h3>
          <hr>
          <p>Lihat Spareparts Lainnya Disini</p>
        </div>
